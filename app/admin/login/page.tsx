      ...
      <div className="bg-blue-500 text-white p-8 md:w-1/2 flex flex-col justify-center">
        ...
        >
          ...
          <p className="text-blue-100 mb-8">
            Secure access for election administrators. If you are a voter, please use the regular login.
          </p>
          <Button
            variant="outline"
          ...
          <div className="mt-12">
            <img
              src="https://images.pexels.com/photos/6457515/pexels-photo-6457515.jpeg?auto=compress&cs=tinysrgb&w=600"
              alt="Admin"
